...
public class HttpClientUtil
{
    ...
    private static final List<String> USER_AGENTS = new ArrayList<>(Arrays.asList("Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; AcooBrowser; .NET CLR 1.1.4322; .NET CLR 2.0.50727)",
    ...
    static {
        ...
        RequestConfig requestConfig = RequestConfig.custom()
                ...
                .setSocketTimeout(TIMEOUT)
                .build();
        httpClientWithoutProxy = build.setDefaultRequestConfig(requestConfig).build();  //  without proxy
